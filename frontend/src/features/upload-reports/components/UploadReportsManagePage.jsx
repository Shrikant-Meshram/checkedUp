        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="rounded-lg border border-border px-4 py-2 type-primary-body-b2 font-medium text-foreground hover:bg-accent transition"
            >
              Cancel
            </button>
            <button
              ...
              className="rounded-lg bg-primary px-4 py-2 type-primary-body-b2 font-medium text-white hover:bg-primary/90 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {uploading ? (
                <>
