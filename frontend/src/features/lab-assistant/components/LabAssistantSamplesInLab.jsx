  ...
  return (
    <div className="bg-card rounded-xl border border-border shadow-sm p-4 sm:p-5">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h3 className="type-primary-heading-h3-medium text-foreground">Samples in Lab</h3>
        <button
        ...
        <table className="w-full type-primary-body-b2">
          <thead>
            <tr className="border-b border-border">
              <th className="text-left py-2.5 text-muted-foreground type-primary-body-b3-medium uppercase tracking-wider">Sample ID</th>
              ...
              <th className="text-left py-2.5 text-muted-foreground type-primary-body-b3-medium uppercase tracking-wider hidden md:table-cell">Test/Package</th>
              <th className="text-left py-2.5 text-muted-foreground type-primary-body-b3-medium uppercase tracking-wider hidden lg:table-cell">Received Time</th>
          ...
          <tbody>
            {(data || []).map((item) => (
              <tr key={item._id} className="border-b border-border/50 last:border-0">
                <td className="py-2.5 sm:py-3">
                  <span className="type-primary-body-b3-medium text-primary sm:text-[13px]">{item.sampleId}</span>
                </td>
            ...
            {(!data || data.length === 0) && (
              <tr>
                <td colSpan={5} className="py-6 sm:py-8 text-center text-muted-foreground type-primary-body-b3">No samples in lab</td>
              </tr>
            )}
          </tbody>
        </table>
