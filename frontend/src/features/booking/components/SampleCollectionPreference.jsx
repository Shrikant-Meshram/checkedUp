    ...
    <div className="space-y-4">
      <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <p className="type-primary-body-b2 font-semibold text-foreground">Home Collection</p>
            <p className="type-primary-body-b3 text-primary font-medium">FREE</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="type-primary-body-b2 font-semibold text-primary mb-1">Important Fasting Instructions</p>
            ...
            <ul className="mt-2 space-y-1">
              {[
                ...
                <li key={i} className="flex items-start gap-2 type-primary-body-b3 text-foreground">
