        ...
        <table className="w-full type-primary-body-b2">
          <thead>
            <tr className="border-b border-border">
              <th className="text-left py-2.5 type-primary-body-b3-medium uppercase tracking-wider">Invoice ID</th>
              ...
              <th className="text-left py-2.5 type-primary-body-b3-medium uppercase tracking-wider hidden sm:table-cell">Date</th>
            </tr>
          </thead>
          <tbody>
            {(data || []).map((payment) => (
              <tr key={payment._id} className="border-b border-border/50 last:border-0">
                <td className="py-2.5 sm:py-3">
                  <span className="type-primary-body-b3-medium text-primary">{payment.invoiceId}</span>
                </td>
                <td className="py-2.5 sm:py-3 text-right type-primary-body-b2-medium text-foreground">
                  {formatCurrency(payment.amount)}
                </td>
                <td className="py-2.5 sm:py-3">
                  <span className={`px-2 sm:px-2.5 py-0.5 rounded-md type-primary-body-b4-medium ${paymentStyles[payment.status] || 'bg-gray-50 text-gray-600'}`}>
                    {payment.status}
                  </span>
                </td>
                <td className="py-2.5 sm:py-3 type-primary-body-b3 text-muted-foreground hidden sm:table-cell">
