...
export const labOwnerManageColumns: ColumnDef<LabOwnerRecord, any>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const owner = row.original
      return (
        <div className="type-primary-body-b3">
      ...
      return (
        <div className="flex items-center gap-1.5 w-max max-w-[220px]">
          ...
          <div className="group/tooltip relative flex-1 min-w-0">
            <p className="truncate type-primary-body-b3 text-muted-foreground cursor-pointer">
              {address}
            </p>
            <div
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const count = pincodes?.length || 0
        if (count === 0) return <p className="type-primary-body-b3 text-muted-foreground">—</p>
      return (
        <div className="flex items-center gap-1.5">
          <span className="bg-primary/10 text-primary px-2.5 py-1 rounded-full type-primary-body-b3 font-semibold">
