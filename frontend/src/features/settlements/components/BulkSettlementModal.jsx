      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="p-3 bg-accent rounded-lg">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="type-primary-body-b2-medium text-foreground">Settlement Summary</span>
          </div>
          <div className="grid grid-cols-2 gap-3 type-primary-body-b2">
            <div>
              ...
              <p className="type-primary-body-b2-medium">{summary.count}</p>
            </div>
            <div>
              <p className="type-primary-body-b3 text-muted-foreground">Total Amount</p>
              <p className="type-primary-body-b2-medium">{formatCurrency(summary.totalAmount)}</p>
            </div>
            <div>
              <p className="type-primary-body-b3 text-muted-foreground">Lab Share (85%)</p>
              <p className="type-primary-body-b2-medium text-primary">{formatCurrency(summary.labShare)}</p>
            </div>
            <div>
              <p className="type-primary-body-b3 text-muted-foreground">Commission (15%)</p>
              <p className="type-primary-body-b2-medium">{formatCurrency(summary.commission)}</p>
            </div>
          </div>
        </div>
